...
* **OverTime Impact**: Analyzes the correlation between overtime work and attrition.
* **Education Field Analysis**: Highlights which academic backgrounds are leaving the company most frequently.

### 🛠️ Tech Stack Used:
* Power BI Desktop
* Power Query (Data Cleaning & Conditional Columns)
* DAX (Measures & Visual Formatting)
